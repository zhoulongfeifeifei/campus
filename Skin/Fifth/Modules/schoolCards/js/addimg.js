    ...
    init: {
        ...
        FileUploaded: function (up, file, data) {
            ...
            if (result.status == 1) {
                ...
                commonFn({ url: 'XAWebCommon/Update_LunboImg?devideids=' + devices + '&img=' + result.data[0] + '&title=' + title + '&type=1&position=1', type: 'GET' }, function (res) {
                    console.log(res);
