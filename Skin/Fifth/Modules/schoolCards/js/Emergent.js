...
if (window.location.search.indexOf('?id=') != -1) {
        ...
        function aa(current) {
            ...
            commonFn({ url: 'XAWebCommon/GetList_Notice', type: 'POST', data: data }, function (res) {
                ...
                $.each(info, function (i) {
                    ...
                    $('.table table tbody').append('<tr><td ><p class="text-shenglue" style="width: 300px;">' + info[i].detail +
                        '</p></td><td>' + intime + '</td><td>' + publishDate + '</td><td>' + st + t + '</td><td>' +
                        info[i].name + '</td><td class="edit"><a class="text link" href="addEmergent.html?clint=' + info[i].device + '&id=' + info[i].id + '&sta=' + info[i].state + '">编辑</a>' +
                ...
                $(".publish").click(function () {
                    ...
                    commonFn({ url: 'XAWebCommon/Update_Notice', type: 'POST', data: model }, function (res) {
                        ...
                        // } 
                        location.href = 'Emergent.html' + window.location.search;
    ...
    $('#add').attr('href', 'addEmergent.html?clint_id=' + num);
        ...
        function aa(current) {
            ...
            commonFn({ url: 'XAWebCommon/GetList_NoticeByDevice', type: 'POST', data: data }, function (res) {
                ...
                $.each(info, function (i) {
                    ...
                    $('.table table tbody').append('<tr><td ><p class="text-shenglue" style="width: 300px;">' + info[i].detail +
                        '</p></td><td>' + intime + '</td><td>' + publishDate + '</td><td>' + st + t + '</td><td>' +
                        info[i].name + '</td><td class="edit"><a class="text link" href="addEmergent.html?clint_id=' + num + '&id=' + info[i].id + '&sta=' + info[i].state + '">编辑</a>' +
