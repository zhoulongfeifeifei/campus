...
preDataArr=[
		{id:0,name:"单行输入框",class:'item-single',editId:'0,1,7',Dom:''+
			'<li class="item item-single" data-typeid="0">'+
				...
				'<span class="s-placeholder">请输入</span>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:0&,0&:单行输入框&,1&:请输入&,7&:true&," />'+
			'</li>'},
		{id:1,name:"多行输入框",class:'item-multi',editId:'0,1,7',Dom:''+
			'<li class="item item-multi active" data-typeid="1">'+
				...
				'<span class="s-placeholder">请输入</span>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:1&,0&:多行输入框&,1&:请输入&,7&:true&," />'+
			'</li>'},
		{id:2,name:"数字输入框",class:'item-number',editId:'0,1,2,7',Dom:''+
			'<li class="item item-number active" data-typeid="2">'+
				...
				'<span class="s-placeholder">请输入</span>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:2&,0&:数字输入框&,1&:请输入&,2&:&,7&:true&," />'+
			'</li>'},
		{id:3,name:"单选框",class:'item-radio',editId:'0,3,7',Dom:''+
			'<li class="item item-radio item-radio-close active" data-typeid="3">'+
				...
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:3&,0&:单选框&,3&:&;&;&;&,7&:true&," />'+
			'</li>'},
		{id:4,name:"多选框",class:'item-check',editId:'0,3,4,7',Dom:''+
			'<li class="item item-check item-check-close active" data-typeid="4">'+
				...
				'<span class="s-right">请选择</span>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:4&,0&:多选框&,3&:&;&;&;&,4&:0&,7&:true&," />'+
			'</li>'},
		{id:5,name:"日期区间",class:'item-date-multi',editId:'0,0,5,7',Dom:''+
			'<li class="item item-date-multi active" data-typeid="5">'+
				...
				'</div>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:5&,0&:开始时间&,0&:结束时间&,5&:0&,7&:true&," />'+
			'</li>'},
		{id:6,name:"日期",class:'item-date',editId:'0,5,7',Dom:''+
			'<li class="item item-date active" data-typeid="6">'+
				...
				'</div>'+
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:6&,0&:日期&,5&:0&,7&:true&," />'+
			'</li>'},
		{id:7,name:"照片",class:'item-pic',editId:'0,7',Dom:''+
			'<li class="item item-pic active" data-typeid="7">'+
				...
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:7&,0&:照片&,7&:true&," />'+
			'</li>'},
		{id:8,name:"明细",class:'item-box',editId:'0,8',Dom:''+
			'<li class="item item-box active" data-typeid="8">'+
				...
				'<i class="s-close"></i>'+
				'<input class="input-hidden" value="typeid&:7&,0&:明细&,8&:增加明细&," />'+
			'</li>'},
	];
...
$(function(){
			...
			switch(EditArr.type){
				...
				case 'mulit-text':
					_html+='<div class="r-item r-item-radio">'+
							...
							'<div class="r-item-b">'+
								  '<div class="item-b-n">'+
									  '<input type="text" data-limit="'+EditArr.limit+'" class="input-text"/><i class="remove "></i><i class="add "></i>'+
								  '</div>'+
								  '<div class="item-b-n">'+
									  '<input type="text" data-limit="'+EditArr.limit+'" class="input-text"/><i class="remove "></i><i class="add "></i>'+
								  '</div>'+
	...
	$rBox_1.on('click','.r-item-radio .add',function(){
		$(this).parents('.item-b-n').after('<div class="item-b-n">'+
					'<input class="input-text"/><i class="remove "></i><i class="add "></i>'+
				'</div>');
		reSelect();
	});
	...
	function setByMid(){
		...
		$.each(_inputValArr,function(i,val){
			...
			switch(_rid){
				...
				case '4':
				case '5':
					//$rBox_1.find('.r-item').eq(i).find('select option').eq(_valArr[1])[0].attr('selected',true);
					break;
				case '7':
					if(_valArr[1]==='true'){
