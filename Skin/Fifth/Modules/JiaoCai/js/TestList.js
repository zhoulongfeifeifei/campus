...
//	});
	...
	$(".addnigao").on("click", function() {
		Url = "TKResource/AddResTest?schoolid="+schoolid;
	})
//添加
	function add() {
		$("#parent").show();
...
function dele() {
	layer.confirm('你确定要删除该栏目吗？',{icon:3,title:'提示'},function(index){
		var  DeleteResChapter = {
			type:'get',
			url:"TKResource/DeleteResTest?id="+actionNodeID+"&schoolId="+schoolid+""
		}
