...
commonFn({ url: 'XAWebBanpai/Get_AllScreen?sno=' + num + '&deviceid=0', type: 'GET' }, function (res) {
    ...
    $.each(str1, function (i) {
        $('#wei').append('<input type="checkbox" name="device" class="device" value="' + str1[i] + '" checked="checked" />' + str1[i]);
    })
    ...
    init: {
        ...
        FileUploaded: function (up, file, data) {
            ...
            if (result.status == 1) {
                ...
                commonFn({ url: 'XAWebBanpai/Update_BaPing?deviceids=' + devices + '&img=' + result.data[0] + '&sno=' + num + '&message=' + mes + '&schoolid=' + window.schoolid + '&type=0', type: 'GET' }, function (res) {
                    console.log(res);
